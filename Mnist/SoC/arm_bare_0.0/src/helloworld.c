...
//	xil_printf("Xtime_2: 0x%08x\t 0x%08x\n\r", Xtime_2, (Xtime_2 >> 32));
...
#if 0
	// TIMER Instance: AXI_TIMER
	XTmrCtr timer_dev;
	int Status;
	u32 init_time, curr_time, calibration, begin_time, end_time, run_time_sw;
	...
	xil_printf("init_time_0: 0x%08x\n", init_time);
	xil_printf("curr_time_0: 0x%08x\n", curr_time);
	calibration = curr_time - init_time;
	xil_printf("calibration_0: 0x%08x\n", calibration);
